    ...
    <div class="col-md-8 mx-auto">
      <div class="card">
        <div class="card-header">
          <h4 class="text-primary text-center"> Lista de atendimentos pendentes</h4>
          <div class="text-center"><button class="btn btn-danger"> Carregar</button> </div>
        </div>
        <div class="card-body">
          <div class="result">
